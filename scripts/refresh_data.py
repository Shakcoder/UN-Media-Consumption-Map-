...
def main() -> int:
    ...
    result["_meta"] = {
        ...
        "data_sources": [
            ...
            "Wikipedia station lists + Wikidata records (extended per-country TV-station lists in data/tv_stations.json, automated monthly; every entry gated through Wikidata for country/active-status/typing; presence-ranked, not viewership)",
