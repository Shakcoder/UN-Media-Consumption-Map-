#!/usr/bin/env python3
"""
compute_arabbarometer_w7.py — news-source shares from Arab Barometer Wave VII.

INPUT (not in this repo — Arab Barometer data stays local per its terms):
  ~/Downloads/AB7/AB7_ENG_Release_Version6.sav
  Free download after a short form: arabbarometer.org → Survey Data →
  Data Downloads → Wave VII → Data Sets.
...
No trust-in-media question exists anywhere in Wave VII — trust stays None.

Wave VII countries: Algeria, Egypt, Iraq, Jordan, Kuwait, Lebanon, Libya, Mauritania,
Palestine, Tunisia (2021-2022 fieldwork).

Citation: Arab Barometer Wave VII (2021-2022), Arab Barometer,
...
SAV = (Path.home() / "Downloads" / "AB7"
       / "AB7_ENG_Release_Version6.sav")

COUNTRY_TO_A3 = {1.0: "DZA", 5.0: "EGY", 7.0: "IRQ", 8.0: "JOR", 9.0: "KWT",
                 10.0: "LBN", 11.0: "LBY", 12.0: "MRT", 13.0: "MAR",
                 15.0: "PSE", 19.0: "SDN", 21.0: "TUN"}
...
def main() -> int:
    ...
    dump = SAV.parent / "ab_w7_news_primary_source.json"
    ...
    for iso3 in sorted(out):
        ...
        print(
            ...
            f'            "src": "Arab Barometer Wave VII (2021-2022) microdata",\n'
