...
- **Daily** — the trend engine (GitHub Actions) refreshes Wikipedia-attention and GDELT news-coverage signals, each country's most-read Wikipedia pages, and each country's trending Google searches.
